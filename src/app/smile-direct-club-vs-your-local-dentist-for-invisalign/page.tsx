...
export default function SmileDirectClubVsLocalDentistPage() {
  return (
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mb-12">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="relative">
                <div className="relative pb-[56.25%] h-0">
                  <iframe
                    ...
                    src="https://www.youtube.com/embed/cZxjPhjlkk0"
                    title="Smile Direct Club vs Local Dentist - Patient Testimonial"
                    frameBorder="0"
              ...
              {/* Right Column - Testimonial Conversation */}
          ...
          {/* Pros and Cons Section - 2 Columns */}
          <div className="mb-12">
            <div className="grid lg:grid-cols-2 gap-8">
              {/* Left Column - Pros */}
              <div>
